...
const TEXT_COLOR_PRESETS = [
  { label: "Dark Charcoal", value: "#1A1A1A" },
    ...
    <>
      <div className="admin-form-wrapper flex flex-col xl:flex-row gap-6 p-4 sm:p-6">
        ...
        <div className="flex-1 min-w-0 max-w-2xl">
          {/* Typography & Colors Menu Bar */}
          <div className="bg-[#142618] rounded-xl p-5 mb-5 border border-[#c4a86b]/40 shadow-lg">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                title="Reset font and colors to default (Ebrima + CentzMi Red)"
              >
                ↺ Reset Defaults
              </button>
            </div>
