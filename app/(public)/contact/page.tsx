  ...
  return (
    <>
      ...
      <section className="bg-[#faf7f2] py-20 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <a href="tel:+2348066079075" className="text-sm text-[#1e3323] hover:text-[#c4a86b] transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
                +234 (0)806 607 9075
              </a>
            </div>
            <div>
              <p className="text-xs tracking-[0.25em] uppercase text-[#c4a86b] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>Email</p>
              <a href="mailto:info@centzmi.com" className="text-sm text-[#1e3323] hover:text-[#c4a86b] transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
                info@centzmi.com
              </a>
            </div>
            <div>
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-[#1e3323] text-[#f5f0e8] text-sm font-semibold py-4 rounded-full hover:bg-[#d60015] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                  style={{ fontFamily: "Inter, sans-serif" }}
                >
        ...
        {/* Google Maps */}
        <a
          href="https://maps.google.com/maps?q=4.805538,7.023238"
          target="_blank"
