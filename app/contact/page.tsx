        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <a href="tel:+2348066079075" className="text-sm text-[#7A000D] hover:text-[#c4a86b] transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
                +234 (0)806 607 9075
              </a>
            </div>
            <div>
              <p className="text-xs tracking-[0.25em] uppercase text-[#c4a86b] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>Email</p>
              <a href="mailto:info@centzmi.com" className="text-sm text-[#7A000D] hover:text-[#c4a86b] transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
                info@centzmi.com
              </a>
            </div>
            <div>
