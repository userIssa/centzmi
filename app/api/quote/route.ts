...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;color:#3d6040">
          <div style="background:#3d6040;padding:32px;text-align:center">
          ...
          <div style="padding:32px;background:#faf7f2;border:1px solid #ede7db">
            ...
            <div style="margin-top:24px;padding:16px;background:#3d6040;border-radius:8px;text-align:center">
        ...
        <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;color:#3d6040">
          ...
          <div style="padding:40px;background:#faf7f2;border:1px solid #ede7db">
            ...
            <div style="text-align:center;margin-top:8px">
              <a href="${process.env.NEXT_PUBLIC_APP_URL}/portfolio" style="display:inline-block;background:#c4a86b;color:#3d6040;text-decoration:none;padding:14px 32px;border-radius:50px;font-weight:600;font-size:14px">View Our Portfolio</a>
            </div>
          </div>
          <div style="padding:16px;text-align:center;background:#f5f0e8;border:1px solid #ede7db;border-top:none">
